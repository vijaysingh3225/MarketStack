...
class OpenOpenTradeControllerTest
    @Autowired
    constructor(
        val mockMvc: MockMvc,
        val objectMapper: ObjectMapper,
    ) {
        @Value("\${api.open-trade.base-url}")
        lateinit var baseUrl: String

        @Value("\${api.closed-trade.base-url}")
        lateinit var closedUrl: String
        ...
        inner class PostOpenTradeExec {
            ...
            fun `should add a new trade execution in a new trade object`() {
                val group: List<TradeExec> =
                    listOf(
                        TradeExec(
                            id = "142",
                            account = "8923",
                            tradeDate = LocalDate.of(2021, 7, 15),
                            settlementDate = LocalDate.of(2022, 7, 20),
                            currency = "EUR",
                            type = 2,
                            side = "B",
                            symbol = "GOOGL",
                            ...
                            ecnRemove = 0.01,
                            ecnAdd = 0.02,
                            grossProceeds = 409342.50,
                            netProceeds = 409326.18,
                            clearingBroker = "BKR1",
                            liquidity = "High",
                            note = "Executed trade with adjusted settings",
                        ),
                    )
