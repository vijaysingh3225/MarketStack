...
class MockOpenTradeDataSource: OpenTradeDataSource {
    ...
    val mockExec = mutableListOf(
        TradeExec(
            ...
            currency = "USD", type = 3, side = "SS", symbol = "UROY", quantity = 200, price = 4.3038, execTime = LocalTime.of(14, 45, 30),
            commission = 0.0, secFee = 0.01, taf = 0.02, nscc = 0.0, nasdaq = 0.0, ecnRemove = 0.0, ecnAdd = 0.0, grossProceeds = 860.76,
